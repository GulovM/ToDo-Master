...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-l%hge$q57iuuyat-d7tdhx0n7tb@@ij&w_v3j&$6%(fo13%5ld')
...
# Enable JWT token blacklist conditionally to avoid migration errors on environments
# where the blacklist tables are not created. Set JWT_ENABLE_BLACKLIST=true to enable.
if config('JWT_ENABLE_BLACKLIST', default=False, cast=bool):
